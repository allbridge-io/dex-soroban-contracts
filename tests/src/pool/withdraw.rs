...
use crate::{
    utils::{assert_rel_eq, float_to_uint, Snapshot, TestingEnv, TestingEnvConfig, TRIPLE_ZERO},
};
...
fn withdraw_full_and_try_again() {
    ...
    pool.deposit(alice, (4_000.0, 5_000.0, 0.0), 8_999.0); // TODO 3
...
#[test_case(
    ...
    DepositArgs { amounts: (4_000.0, 5_000.0, 0.0), min_lp: 8_999.0 }, // TODO 3
    DoWithdrawArgs { amount: 8999.942, expected_amounts: (4_478.442, 4_521.503, 0.0), expected_fee: TRIPLE_ZERO, expected_rewards: TRIPLE_ZERO, expected_user_lp_diff: 8_999.942, expected_admin_fee: TRIPLE_ZERO } // TODO 3
    ; "base_withdraw"
)]
#[test_case(
    TestingEnvConfig::default().with_pool_fee_share(0.1).with_pool_admin_fee(20.0),
    DepositArgs { amounts: (4_000.0, 5_000.0, 0.0), min_lp: 8_999.0 },  // TODO 3
    DoWithdrawArgs { amount: 8999.942, expected_amounts: (4_473.963, 4_516.981, 0.0), expected_fee: (4.478_442, 4.521_503, 0.0), expected_rewards: TRIPLE_ZERO, expected_user_lp_diff: 8_999.942, expected_admin_fee: (0.895_688_4, 0.904_300_6, 0.0) } // TODO 3
    ; "withdraw_with_fee"
)]
#[test_case(
    TestingEnvConfig::default(),
    DepositArgs { amounts: (15_000.0, 25_000.0, 0.0), min_lp: 39_950.0 }, // TODO 3
    DoWithdrawArgs { amount: 0.002, expected_amounts: (0.002, 0.001, 0.0), expected_fee: TRIPLE_ZERO, expected_rewards: TRIPLE_ZERO, expected_user_lp_diff: 0.002, expected_admin_fee: TRIPLE_ZERO } // TODO 3
    ; "smallest_withdraw"
)]
#[test_case(
    TestingEnvConfig::default().with_pool_fee_share(0.1),
    DepositArgs { amounts: (15_000.0, 25_000.0, 0.0), min_lp: 39_950.0 }, // TODO 3
    DoWithdrawArgs { amount: 0.004, expected_amounts: (0.002, 0.001, 0.0), expected_fee: (0.000_003, 0.000_002, 0.0), expected_rewards: TRIPLE_ZERO, expected_user_lp_diff: 0.004, expected_admin_fee: TRIPLE_ZERO } // TODO 3
    ; "smallest_withdraw_with_fee"
)]
#[test_case(
    TestingEnvConfig::default(),
    DepositArgs { amounts: (50_000_000.0, 5_000.0, 0.0), min_lp: 31_250_000.0 }, // TODO 3
    DoWithdrawArgs { amount: 31_492_001.072, expected_amounts: (49_783_831.892, 104_337.373, 0.0), expected_fee: TRIPLE_ZERO, expected_rewards: TRIPLE_ZERO, expected_user_lp_diff: 31_492_001.072, expected_admin_fee: TRIPLE_ZERO } // TODO 3
    ; "withdraw_disbalance"
)]
...
fn withdraw_with_rewards() {
    ...
    let deposits = (4_000.0, 5_000.0, 0.0); // TODO 3
    ...
    let expected_rewards = (0.0430_620, 0.0430_619, 0.0); // TODO 3
    // Withdraw amounts sum is less than deposit amounts sum
    let expected_withdraw_amounts = (4_473.963, 4_516.981, 0.0); // TODO 3
    let expected_fee = (4.478_442, 4.521_503, 0.0); // TODO 3

    pool.deposit(alice, deposits, 8_950.0);
    pool.swap(bob, bob, 1_000.0, 995.5, token_a, token_b);
    pool.swap(bob, bob, 1_000.0, 999., token_b, token_a);
...
fn withdraw_multiply_times() {
    ...
    let deposit = (4_000.0, 5_000.0, 0.0); // TODO 3
    let n = 4usize;
...
fn withdraw_alice_profit_and_bob_loss() {
    ...
    let deposit = (100_000.0, 100_000.0, 0.0); // TODO 3
    let swap_amount = 100_000.;
    let expected_user_withdraw_lp_diff = 200_000.0;
    let expected_rewards = (0.0, 49.217_997_4, 0.0); // TODO 3
    // Alice should withdraw more than she deposited
    let expected_withdraw_amounts = (149_850.0, 50731.22, 0.0); // TODO 3
    let expected_alice_profit = 630.437_997_4;
    let expected_bob_losses = 1_662.440_995_0;
    let expected_fee = (150.0, 50.782_003, 0.0); // TODO 3
...
fn withdraw_alice_loss_and_bob_profit() {
    ...
    let deposit = (200_000.0, 0.0, 0.0); // TODO 3
    let swap_amount = 100_000.;
    let expected_user_withdraw_lp_diff = 198_393.264;
    let expected_rewards = (50.598_436_60, 0.0, 0.0); // TODO 3
    // Alice should withdraw less than she deposited (198_393.304)
    let expected_withdraw_amounts = (98_697.812, 99_497.098, 0.0); // TODO 3
    let expected_alice_loss = 1_754.491_563_4;
    let expected_bob_profit = 1_505.050_343;
    let expected_fee = (98.796_609, 99.596_695, 0.0); // TODO 3
