...
use crate::{
    utils::{Snapshot, TestingEnv, TestingEnvConfig, TRIPLE_ZERO},
};
...
fn deposit_slippage() {
    ...
    testing_env
        .pool
        .deposit(&testing_env.alice, (100.0, 0.0, 0.0), 100.0);
}
...
fn deposit_invalid_first_deposit() {
    ...
    testing_env
        .pool
        .deposit(&testing_env.alice, (100.0, 25.0, 50.0), 0.0);
}

#[test_case((100.0, 50.0, 0.0), TRIPLE_ZERO, 150.0 ; "base")] //TODO 3
#[test_case((50_000_000.0, 5_000.0, 0.0), TRIPLE_ZERO, 31_492_001.072 ; "deposit_disbalance")] //TODO 3
#[test_case((0.001, 0.001, 0.0), TRIPLE_ZERO, 0.002 ; "smallest_deposit")] //TODO 3
#[test_case((100.0, 0.0, 0.0), TRIPLE_ZERO, 99.998 ; "deposit_only_a")] //TODO 3
#[test_case((0.0, 100.0, 0.0), TRIPLE_ZERO, 99.998 ; "deposit_only_b")] //TODO 3
...
fn deposit_twice_in_different_tokens() {
    ...
    snapshot_before.print_change_with(&snapshot_after, "Deposit: 100 a, 100 b");
...
fn get_reward_after_second_deposit() {
    ...
    let deposit = (2_000.0, 2_000.0, 0.0); //TODO 3
    let expected_rewards = (1.001_219_9, 0.998_779_9, 0.0); //TODO 3
    let expected_lp_amount = 4_000.0;

    pool.deposit(alice, deposit, 4_000.0);
    pool.swap(alice, bob, 100.0, 98.0, token_a, token_b);
    pool.swap(bob, alice, 100.0, 99.0, token_b, token_a);
