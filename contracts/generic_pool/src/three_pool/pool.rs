...
use super::{
    events::{ThreeDeposit, ThreeRewardsClaimed, ThreeWithdraw},
    three_pool::ThreePool,
    token::ThreeToken,
};

impl Pool<3> for ThreePool {
    type Deposit = ThreeDeposit;
    type RewardsClaimed = ThreeRewardsClaimed;
    type Withdraw = ThreeWithdraw;
...
mod tests {
    ...
    use crate::{storage::sized_array::SizedU128Array, three_pool::three_pool::ThreePool};
