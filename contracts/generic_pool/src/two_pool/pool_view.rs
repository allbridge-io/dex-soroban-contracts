...
use super::{token::TwoToken, two_pool::TwoPool, utils::get_double_tuple_from_sized_u128_array};

#[contracttype]
#[derive(Debug)]
pub struct TwoWithdrawAmountView {
    /// system precision
...
impl<const N: usize> From<WithdrawAmount<N>> for TwoWithdrawAmountView {
...
impl PoolView<2, TwoToken> for TwoPool {
